...
def test_metrics_has_required_fields(client, auth_headers, mock_redis_client):
    ...
    with patch("api.metrics.SessionLocal") as MockSession:
        ...
        mock_db.query.return_value.filter.return_value.order_by.return_value.all.return_value = [(100.0,), (200.0,), (300.0,)]
...
def test_metrics_hit_rate_is_float(client, auth_headers, mock_redis_client):
